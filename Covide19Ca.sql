...
select * from Covid19ca

/*sp_help Covid19ca*/

select * from Covid19ca

delete from Covid19Ca where 
pruid = 1
 ...
 set 
 date = replace(date, '-', '')
 alter table Covid19ca
 alter column date int***/

 select * from Covid19Ca
 

 sp_rename "Covid19Ca.update",  "updated", "column"
 
 alter table Covid19ca
 alter column [pruid] int

 alter table Covid19ca
 alter column [updated] int

 alter table Covid19ca
 alter column [numdeathstoday] int

 alter table Covid19ca
 alter column [numteststoday] int

 alter table Covid19ca
 alter column [numactive] int

 alter table Covid19ca
 alter column [numrecoveredtoday] int

  alter table Covid19ca
 alter column numtestedtoday int
 ...
 /*create a table, and insert data from another db object using insert into key word*/
